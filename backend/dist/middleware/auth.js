...
export function authMiddleware(req, res, next) {
    ...
    try {
        ...
        console.log(`✅ Authentifié : ${decoded.username} (${decoded.role}) — ${req.method} ${req.originalUrl}`);
        next();
    }
    catch (err) {
...
export function roleMiddleware(roles) {
    ...
    return (req, res, next) => {
        ...
        console.log(`🔐 Vérification des droits : ${user.username} (${user.role}) → route ${req.originalUrl}`);
